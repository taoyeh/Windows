...
namespace WritingBoard
{
    public partial class WritingBoard : Form
    {
        ...
        private void WritingBoard_FormClosing(object sender, FormClosingEventArgs e)
        {

            if (MessageBox.Show("您确定要退出"+Text+"?", "警告版", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) == DialogResult.No) { e.Cancel=true; };
